...
export class FlString extends ExtensibleFunction {
...
export class FlNumber extends ExtensibleFunction {
    constructor(value, parent) {
        super(() => { return this.value; });
        this.id = crypto.randomUUID();
        this.value = value;
...
export class FlMappedObject extends ExtensibleFunction {
    constructor(value, parent) {
        super(() => { return this.value; });
        this.id = crypto.randomUUID();
        this.value = value;
...
export class FlArray extends ExtensibleFunction {
    constructor(value, parent) {
        super(() => { return this.value; });
        this.id = crypto.randomUUID();
        this.value = value;
...
export function createState(value, parent) {
    ...
    if (typeofValue == "string") {
        return new FlString(value, parent);
    }
