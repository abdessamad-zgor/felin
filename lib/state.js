...
export class FlexString extends ExtensibleFunction {
...
export class FlexNumber extends ExtensibleFunction {
    constructor(value, parent) {
        super(() => { return this.value; });
        this.id = crypto.randomUUID();
        this.value = value;
...
export class FlexMappedObject extends ExtensibleFunction {
    constructor(value, parent) {
        super(() => { return this.value; });
        this.id = crypto.randomUUID();
        this.value = value;
...
export class FlexArray extends ExtensibleFunction {
    constructor(value, parent) {
        super(() => { return this.value; });
        this.id = crypto.randomUUID();
        this.value = value;
...
export function createState(value, parent) {
    ...
    if (typeofValue == "string") {
        return new FlexString(value, parent);
    }
